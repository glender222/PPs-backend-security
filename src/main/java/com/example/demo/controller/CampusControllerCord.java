...
@RestController
@RequestMapping("/mantenercord")
@CrossOrigin(origins = "http://localhost:4200")
@PreAuthorize("hasRole('COORDINADOR')") 
public class CampusControllerCord {
private final CampusService campusService;
    private final FacultadService facultadService;
    private final EscuelaProfesionalService escuelaProfesionalService;

    public CampusControllerCord(CampusService campusService, FacultadService facultadService, EscuelaProfesionalService escuelaProfesionalService) {
